...
public:
	...
	void createCube(int l)
	{

		add( Point3d(0,0,0,1), L"A");
		add( Point3d(l,0,0,1), L"B");
		add( Point3d(l,l,0,1), L"C");
		add( Point3d(0,l,0,1), L"D");
		add( Point3d(0,0,0,1));
		add( Point3d(0,0,l,1), L"E");
		add( Point3d(l,0,l,1), L"F");
		add( Point3d(l,0,0,1));
		add( Point3d(l,0,l,1));
		add( Point3d(l,l,l,1), L"G");
		add( Point3d(l,l,0,1));
		add( Point3d(l,l,l,1));
		add( Point3d(0,l,l,1), L"H");
		add( Point3d(0,l,0,1));
		add( Point3d(0,l,l,1));
		add( Point3d(0,0,l,1));
